...
class iitm_slider {
	...
	function iitm_slider() {
		add_action('init',array($this,'create_post_type'));
		add_action('init',array($this,'create_taxonomies'));
		add_action('manage_iitm_slider_posts_columns',array($this,'columns'),10,2);
		add_action('manage_iitm_slider_posts_custom_column',array($this,'column_data'),11,2);
	...
	function create_post_type() {
		...
		register_post_type( 'iitm_slider', $args );
	}
	...
	function create_taxonomies() {
		...
		register_taxonomy('iitm_slider_type',array('iitm_slider'),$args);
		...
		register_taxonomy('iitm_slider_attribute','iitm_slider',$args);
	}

	function columns($columns) {
		unset($columns['date']);
		unset($columns['taxonomy-iitm_slider_attribute']);
	...
	function join($wp_join) {
		global $wpdb;
		if(get_query_var('post_type') == 'iitm_slider') {
			$wp_join .= " LEFT JOIN (
